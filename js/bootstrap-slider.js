	...
	var Slider = function(element, options) {
		...
		switch(this.orientation) {
			...
			default:
				...
				this.tooltip_min.addClass('bottom')[0].style.top = -this.tooltip_min.outerHeight() + 30 + 'px';
				this.tooltip_max.addClass('bottom')[0].style.top = -this.tooltip_max.outerHeight() + 30 + 'px';
				break;
		}
